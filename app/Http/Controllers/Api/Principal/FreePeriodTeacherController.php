        ...
        try {
            ...
            return $this->successResponse(
                [
                    ...
                    'teacher_id' => $teacher->id,
                    'teacher_name' => trim($teacher->first_name . ' ' . $teacher->last_name . ' ' . $teacher->sur_name),
                ...
                return $this->successResponse(
                    [
                        'actual_teacher_attendance' => $actualTeacherAttendance ? [
                            ...
                            'teacher_name' => trim($actualTeacher->first_name . ' ' . $actualTeacher->last_name . ' ' . $actualTeacher->sur_name),
                        ...
                        'proxy_teacher_attendance' => [
                            ...
                            'teacher_id' => $proxyTeacher->id,
                            'teacher_name' => trim($proxyTeacher->first_name . ' ' . $proxyTeacher->last_name . ' ' . $proxyTeacher->sur_name),
                            'subject_id' => $subject->id,
                            'subject_name' => $subject->name,
