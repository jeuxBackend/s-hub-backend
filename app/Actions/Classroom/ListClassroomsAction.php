...
class ListClassroomsAction
{
    ...
    {
        $withRelations = ['inCharge', 'subjects.classSubjectRequirement.teacher', 'classSubjectRequirements.teacher', 'teachers', 'students.guardian.authorizedPickup', 'students.todayAttendance'];
